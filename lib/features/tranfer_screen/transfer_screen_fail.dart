...
@RoutePage()
class TransferFailurePage extends StatefulWidget {
  const TransferFailurePage({super.key});

  @override
  State<TransferFailurePage> createState() => _TransferFailurePageState();
}

class _TransferFailurePageState extends State<TransferFailurePage>
